...
import com.llj.base.log.BaseResourceLog;
import com.llj.base.log.LogFoot;
import com.llj.base.log.LogTypeEnum;
import com.llj.base.utils.SerializeUtil;
import com.llj.base.utils.data.CastUtil;
import com.llj.base.utils.data.MyStringUtil;
...
public class ShardedJedisClient extends BaseResourceLog implements JedisClient {
    ...
    private static final Logger log = LogManager
            .getLogger(ShardedJedisClient.class);
    ...
    public ShardedJedisClient(String config_name) throws FileNotFoundException,
            IOException {
    ...
    public ShardedJedisClient(String config_name, String HA_flag)
    ...
    private void initial() throws IOException {
        ...
        if (file.exists()) {
            try {
                ...
                reader = new InputStreamReader(
                        ShardedJedisClient.class.getResourceAsStream("/"
                                + config_path));
            }
        } else {
            reader = new InputStreamReader(
        ...
        if (!MyStringUtil.isEmpty(properties
            ...
            for (int i = 0; i < redis_num; i++) {
                if (MyStringUtil.isEmpty(HA_flag)) {
                    JedisShardInfo jedisShardInfo = new JedisShardInfo(
                            properties.getProperty("redis" + i + ".ip"),
                            Integer.valueOf(properties.getProperty("redis" + i
                                    + ".port")));
                    jedisShardInfo.setPassword(CastUtil.castString(
                            properties.getProperty("redis" + i + ".pwd")));
                    list.add(jedisShardInfo);
                } else {
                    JedisShardInfo jedisShardInfo = new JedisShardInfo(
                            properties.getProperty(HA_flag + "_" + "redis" + i
                                    + ".ip"), Integer.valueOf(properties
                            .getProperty(HA_flag + "_" + "redis" + i
                                    + ".port")));
                    jedisShardInfo.setPassword(CastUtil.castString(
                            properties.getProperty(HA_flag + "_" + "redis" + i + ".port")));
                    list.add(jedisShardInfo);
                }
            }
        }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#expire(java.lang.String,
     * int)
     */
    @Override
    public boolean expire(String key, int seconds) {
        ...
        try {
            ...
            doAferService(logFoot, "expire", false,
                    new Object[]{key, seconds}, e);
            return false;
        }
        shardPool.returnResource(shardJedis);
        if (result == null || result != 1) {
            doAferService(logFoot, "expire", false,
                    new Object[]{key, seconds}, false);
            return false;
        }
        doAferService(logFoot, "expire", true, new Object[]{key, seconds},
                true);
        return true;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#setnx(java.lang.String,
     * java.lang.String)
     */
    @Override
    public Long setnx(String key, String value) {
        ...
        try {
            ...
            doAferService(logFoot, "setnx", false, new Object[]{key, value},
                    e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "setnx", true, new Object[]{key, value},
                result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#set(byte[], byte[])
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#set(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#get(java.lang.String)
     */
    @Override
    ...
    public byte[] get(byte[] key) {
        ...
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "get", true, new Object[]{keyStr},
                result == null ? "" : new String(result));
        return result;
    }
    ...
    public Long incrBy(String key, long value) {
        ...
        try {
            ...
            doAferService(logFoot, "incrBy", false,
                    new Object[]{key, value}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "incrBy", true, new Object[]{key, value},
                result);
        return result;
    }
    ...
    public Long decrBy(String key, long value) {
        ...
        try {
            ...
            doAferService(logFoot, "decrBy", false,
                    new Object[]{key, value}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "decrBy", true, new Object[]{key, value},
                result);
        return result;
    }
    ...
    public Set<byte[]> keys(final byte[] pattern) {
        ...
        try {
            ...
            doAferService(logFoot, "keys", false, new Object[]{patternStr},
                    e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "keys", true, new Object[]{patternStr},
                result);
        return result;
    }
    ...
    public String lindex(String key, long index) {
        ...
        try {
            ...
            doAferService(logFoot, "lindex", false,
                    new Object[]{key, index}, e);
            return error_str;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "lindex", true, new Object[]{key, index},
                result);
        return result;
    }
    ...
    public List<String> lrange(String key, long start, long end) {
        ...
        try {
            ...
            doAferService(logFoot, "lrange", false, new Object[]{key, start,
                    end}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "lrange", true,
                new Object[]{key, start, end}, result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#rpush(byte[], byte[])
     */
    @Override
    public Long rpush(byte[] key, byte[] value) {
        ...
        try {
            ...
            doAferService(logFoot, "rpush", false, new Object[]{
                    new String(key), new String(value)}, e);
            return error_num;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "rpush", true, new Object[]{new String(key),
                new String(value)}, result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#rpush(java.lang.String,
     * byte[])
     */
    @Override
    public Long rpush(String key, String value) {
        ...
        try {
            ...
            shardPool.returnBrokenResource(shardJedis);
            log.error("redis rpush error!" + e);
            doAferService(logFoot, "rpush", false, new Object[]{key, value},
                    e);
            return error_num;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "rpush", true, new Object[]{key, value},
                result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#lpop(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#lpush(byte[], byte[])
     */
    @Override
    public Long lpush(byte[] key, byte[] value) {
        ...
        try {
            ...
            doAferService(logFoot, "lpush", false, new Object[]{keyStr,
                    valueStr}, e);
            return error_num;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "lpush", true,
                new Object[]{keyStr, valueStr}, result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see cn.qding.base.common.redis.JedisClient#lpush(java.lang.String,
     * byte[])
     */
    @Override
    public Long lpush(String key, String value) {
        ...
        try {
            ...
            shardPool.returnBrokenResource(shardJedis);
            log.error("redis lpush error!" + e);
            doAferService(logFoot, "lpush", false, new Object[]{key, value},
                    e);
            return error_num;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "lpush", true, new Object[]{key, value},
                result);
        return result;
    }
    ...
    public Long lrem(String key, Long count, String value) {
        ...
        try {
            ...
            doAferService(logFoot, "lrem", false, new Object[]{key, value},
                    e);
            return error_num;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "lrem", true, new Object[]{key, value},
                result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hset()
     */
    @Override
    public Long hset(String key, String field, String value) {
        ...
        try {
            ...
            doAferService(logFoot, "hset", false, new Object[]{key, field,
                    value}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hset", true,
                new Object[]{key, field, value}, result);
        return result;
    }
    ...
    public Long hsetnx(String key, String field, String value) {
        ...
        try {
            ...
            doAferService(logFoot, "hsetnx", false, new Object[]{key, field,
                    value}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hsetnx", true,
                new Object[]{key, field, value}, result);
        return result;
    }
    ...
    public Long hset(byte[] key, byte[] field, byte[] value) {
        ...
        try {
            ...
            shardPool.returnBrokenResource(shardJedis);
            log.error("redis hset error!" + e);
            doAferService(logFoot, "hset", false, new Object[]{keyStr,
                    filedStr, valueStr}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hset", true, new Object[]{keyStr, filedStr,
                valueStr}, result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hget()
     */
    @Override
    public String hget(String key, String field) {
        ...
        try {
            ...
            doAferService(logFoot, "hget", false, new Object[]{key, field},
                    e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hget", true, new Object[]{key, field},
                result);
        return result;
    }
    ...
    public byte[] hget(byte[] key, byte[] field) {
        ...
        try {
            ...
            shardPool.returnBrokenResource(shardJedis);
            log.error("redis hget error!" + e);
            doAferService(logFoot, "hget", false, new Object[]{keyStr,
                    fieldStr}, e);
            return null;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hget", true, new Object[]{keyStr, fieldStr},
                result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hmset()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hmget()
     */
    @Override
    public List<String> hmget(String key, String... fields) {
        ...
        try {
            ...
            doAferService(logFoot, "hmget", false,
                    new Object[]{key, fields}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hmget", true, new Object[]{key, fields},
                result);
        return result;
    }
    ...
    public Boolean hexists(String key, String field) {
        ...
        try {
            ...
            doAferService(logFoot, "hexists", false,
                    new Object[]{key, field}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hexists", true, new Object[]{key, field},
                result);
        return result;
    }
    ...
    public Long hincrby(String key, String field, Long value) {
        ...
        try {
            ...
            doAferService(logFoot, "hincrby", false, new Object[]{key, field,
                    value}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hincrby", true, new Object[]{key, field,
                value}, result);
        return result;
    }
    ...
    public Long hdel(String key, String... fields) {
        ...
        try {
            ...
            doAferService(logFoot, "hdel", false, new Object[]{key, fields},
                    e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hdel", true, new Object[]{key, fields},
                result);
        return result;
    }
    ...
    public Long hdel(byte[] key, byte[] fields) {
        ...
        try {
            ...
            doAferService(logFoot, "hdel", false, new Object[]{keyStr,
                    fieldStr}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "hdel", true, new Object[]{keyStr, fieldStr},
                result);
        return result;
    }
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hlen(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hkeys(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.qding.base.common.redis.JedisClient#hvals(java.lang.String)
     */
    @Override
    ...
    public <T extends Serializable> List<T> hvalsToObject(String key) {
        ...
        try {
            ...
            doAferService(logFoot, "hvalsToObject", false,
                    new Object[]{key}, e);
            return null;
        }
        shardPool.returnResource(shardJedis);
        ...
        doAferService(logFoot, "hvalsToObject", true, new Object[]{key},
                list);
        return list;
    }
    ...
    public Long sadd(String key, String... member) {
        ...
        try {
            ...
            doAferService(logFoot, "sadd", false, new Object[]{key, member},
                    e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "sadd", true, new Object[]{key, member},
                result);
        return result;
    }
    ...
    public Long srem(String key, String... members) {
        ...
        try {
            ...
            doAferService(logFoot, "srem", false,
                    new Object[]{key, members}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "srem", true, new Object[]{key, members},
                result);
        return result;
    }
    ...
    public Boolean sismember(String key, String member) {
        ...
        try {
            ...
            doAferService(logFoot, "sismember", false, new Object[]{key,
                    member}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "sismember", true, new Object[]{key, member},
                result);
        return result;
    }
    ...
    public Long zadd(String key, long score, String member) {
        ...
        try {
            ...
            doAferService(logFoot, "zadd", false, new Object[]{key, score,
                    member}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zadd", true,
                new Object[]{key, score, member}, result);
        return result;
    }
    ...
    public Long zadd(String key, Map<String, Double> scoreMembers) {
        ...
        try {
            ...
            shardPool.returnBrokenResource(shardJedis);
            log.error("redis zadd error!" + e);
            doAferService(logFoot, "zadd", false, new Object[]{key,
                    scoreMembers}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zadd", true,
                new Object[]{key, scoreMembers}, result);
        return result;
    }
    ...
    public Set<String> zrange(String key, long start, long end) {
        ...
        try {
            ...
            doAferService(logFoot, "zrange", false, new Object[]{key, start,
                    end}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrange", true,
                new Object[]{key, start, end}, result);
        return result;
    }
    ...
    public Set<String> zrevrange(String key, long start, long end) {
        ...
        try {
            ...
            doAferService(logFoot, "zrevrange", false, new Object[]{key,
                    start, end}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrevrange", true, new Object[]{key, start,
                end}, result);
        return result;
    }
    ...
    public Set<String> zrangeByScore(String key, double min, double max) {
        ...
        try {
            ...
            doAferService(logFoot, "zrangeByScore", false, new Object[]{key,
                    min, max}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrangeByScore", true, new Object[]{key, min,
                max}, result);
        return result;
    }
    ...
    public Set<String> zrangeByScore(String key, double min, double max,
        ...
        try {
            ...
            log.error("redis zrangeByScore error!" + e);
            doAferService(logFoot, "zrangeByScore", false, new Object[]{key,
                    min, max, offset, count}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrangeByScore", true, new Object[]{key, min,
                max, offset, count}, result);
        return result;
    }
    ...
    public Set<String> zrevrangeByScore(String key, double max, double min) {
        ...
        try {
            ...
            doAferService(logFoot, "zrevrangeByScore", false, new Object[]{
                    key, max, min}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrevrangeByScore", true, new Object[]{key,
                max, min}, result);
        return result;
    }
    ...
    public Long zrem(String key, String... members) {
        ...
        try {
            ...
            doAferService(logFoot, "zrem", false,
                    new Object[]{key, members}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrem", true, new Object[]{key, members},
                result);
        return result;
    }
    ...
    public Long zremrangeByScore(String key, String start, String end) {
        ...
        try {
            ...
            doAferService(logFoot, "zremrangeByScore", false, new Object[]{
                    key, start, end}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zremrangeByScore", true, new Object[]{key,
                start, end}, result);
        return result;
    }
    ...
    public Double zscore(String key, String member) {
        ...
        try {
            ...
            doAferService(logFoot, "zscore", false,
                    new Object[]{key, member}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zscore", true, new Object[]{key, member},
                result);
        return result;
    }
    ...
    public Long zrank(String key, String member) {
        ...
        try {
            ...
            doAferService(logFoot, "zrank", false,
                    new Object[]{key, member}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrank", true, new Object[]{key, member},
                result);
        return result;
    }
    ...
    public Long zrevrank(String key, String member) {
        ...
        try {
            ...
            doAferService(logFoot, "zrevrank", false, new Object[]{key,
                    member}, e);
            return result;
        }
        shardPool.returnResource(shardJedis);
        doAferService(logFoot, "zrevrank", true, new Object[]{key, member},
                result);
        return result;
    }
    ...
    @Override
    public void releaseShardedJedis(ShardedJedis shardJedis,
