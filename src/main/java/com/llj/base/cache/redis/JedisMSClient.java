...
public class JedisMSClient {
    ...
    public JedisMSClient(String config_name) throws FileNotFoundException,
            IOException {
     ...
     * @throws Exception
     */
    public List<String> lrangeFromMaster(String key, long start, long end)
            throws Exception {
     ...
     * @throws Exception
     */
    public List<String> lrangeFromSlave(String key, long start, long end)
            throws Exception {
     ...
     * @throws Exception
     */
    public String lsetFromMaster(String key, long index, String value)
            throws Exception {
     ...
     * @throws Exception
     */
    public String lsetFromSlave(String key, long index, String value)
            throws Exception {
